...
class Brandon {
  ...
  constructor() {
    ...
    this.scale2 = random(-5, 3);

    // if (this.rectWidth1 < 400) {
    // this.widener = this.widener + 0.01;
    // }

    // ellipse variables
    this.rectX = joint.depthX * myCanvas.width + random(-100,100);
    this.rectY = joint.depthY * myCanvas.height + random(-100,100);
    this.rectWidth1 = this.scale1 //+ widener;
    this.rectHeight1 = this.scale2;
  ...
  show() {
    ...
    // fill(254, 0, 123, 100); //hot pink
    // fill(141, 44, 255, 70); //purple
    // fill(0, 0, 0, 100); //grey
    fill(150, 170, 255, 200); //blue
    ...
    // mod-style stars
    ellipse(this.rectX, this.rectY, this.rectWidth1, this.rectHeight2);
